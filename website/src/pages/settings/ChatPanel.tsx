    ...
    <>
      ...
      <SettingsSection title={i18nT('pages.settings.chatPanel.messages')}>
        <SettingsCard index={6}>
          ...
          <SettingsToggle label={i18nT('pages.settings.chatPanel.markdown_cards_open_in_raw_view')} description={i18nT('pages.settings.chatPanel.new_markdown_content_cards_show_source_text_inst')} checked={chatCfg.markdownCardDefaultRaw} onChange={v => setChat('markdownCardDefaultRaw', v)} />
